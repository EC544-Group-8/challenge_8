...
// I need to outling this in my notebook with the most general flow path so I can figure out what the fuck is going on!!


#include <Wire.h>                                 // used by: motor driver
#include <AdafruitMotorShield.h>                 // motor driver
#include <AdafruitPWMServoDriver.h>             // motor driver
#include <NewPing.h>                              // Ping sonar
#include <LiquidCrystal_I2C.h>                    // LCD library
#include <AdafruitSensor.h>                      // part of mag sensor
#include <AdafruitHMC5883U.h>                   // mag sensor
#include <waypointClass.h>                        // custom class to manaage GPS waypoints
#include <AdafruitGPS.h>                         // GPS
...
// LCD Display
LiquidCrystal_I2C lcd(0x27, 2, 1, 0, 4, 5, 6, 7, 3, POSITIVE);  // Set the LCD I2C address and size (4x20)
